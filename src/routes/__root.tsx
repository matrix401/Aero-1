...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "AeroMind — Aviation Intelligence Layer" },
      { name: "twitter:description", content: "AeroMind is a predictive aviation intelligence infrastructure — a synchronized orbital command system that turns weak signals into operational distress probability." },
    ],
    links: [
      {
        rel: "stylesheet",
...
function RootShell({ children }: { children: React.ReactNode }) {
  ...
  dangerouslySetInnerHTML={{
    ...
    })(window, document, "clarity", "script", "x2e1i108a0");`
  }}
/>
      </head>
      <body>
